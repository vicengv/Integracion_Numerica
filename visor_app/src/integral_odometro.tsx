...
const IntegralOdometro = () => {
  ...
  const [rectangulos, setRectangulos] = useState<{ t: number; v: number; dt: number }[]>([]);
  const [litrosConsumidos, setLitrosConsumidos] = useState(0);
  const [rectangulosCombustible, setRectangulosCombustible] = useState<{ t: number; v: number; dt: number }[]>([]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Navigation Tabs */}
        <nav className="bg-white rounded-2xl shadow-lg p-3 mb-8 sticky top-4 z-50 backdrop-blur-sm bg-opacity-95">
          <div className="flex flex-wrap gap-2 justify-center">
            {[
              { id: 'fundamentos', label: 'Fundamentos', icon: '🎓' },
              { id: 'unidades', label: 'Unidades', icon: '📏' },
              { id: 'teoria', label: 'Teoría', icon: '📐' },
              { id: 'simulacion', label: 'Distancia', icon: '🚗' },
        ...
        {tab === 'aplicacion' && (
          <div className="space-y-8">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="p-8">
                {/* Info Box */}
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-r-2xl mb-8">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm">
                    <h4 className="font-bold text-gray-800 mb-4 text-lg border-b pb-2">Funcionalidades:</h4>
                    <ul className="grid md:grid-cols-2 gap-3 text-sm text-gray-600">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-blue-500 mt-1">✓</span>
                        Controlar la velocidad de reproducción (1x - 500x)
                      </li>
                    </ul>
                  </div>
                </div>

                {/* Iframe Container with Browser-like Frame */}
                <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  {/* Reemplazado iframe por componente VisualizadorSimplificado */}
                  <div className="p-6 bg-white rounded-xl">
                    <React.Suspense fallback={<div>Cargando visualizador...</div>}>
                      <VisualizadorSimplificado />
                    </React.Suspense>
                  </div>
                </div>

                {/* Educational Objective */}
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-2xl mt-8 border border-purple-100">
                  <h3 className="font-bold text-2xl mb-4 text-purple-900 flex items-center gap-2">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-blue-500 transform hover:scale-105 transition-transform">
                      <p className="font-bold text-gray-900 mb-2 text-lg">✓ Teoría</p>
                      <p className="text-gray-600">Aprendiste las fórmulas y conceptos de integración numérica</p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-green-500 transform hover:scale-105 transition-transform">
                      <p className="font-bold text-gray-900 mb-2 text-lg">✓ Ejemplos</p>
                      <p className="text-gray-600">Viste simulaciones con datos sintéticos</p>
                    </div>
                    <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-purple-500 transform hover:scale-105 transition-transform">
                      <p className="font-bold text-gray-900 mb-2 text-lg">✓ Práctica</p>
        ...
        {tab !== 'fundamentos' && tab !== 'unidades' && tab !== 'teoria' && tab !== 'simulacion' && tab !== 'combustible' && tab !== 'rendimiento' && tab !== 'aplicacion' && (
          <div className="bg-white rounded-3xl shadow-xl p-12 text-center">
            <div className="text-6xl mb-4">🚧</div>
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Sección en Construcción</h2>
            <p className="text-gray-600 text-lg">
              Esta pestaña contendrá información sobre: <span className="font-semibold">{tab}</span>
            </p>
            <p className="text-gray-500 mt-4">
              Por ahora, visita la pestaña <span className="font-bold text-indigo-600">"Escenario Real"</span> para ver el visualizador funcionando.
            </p>
          </div>
        )}
      </div>
